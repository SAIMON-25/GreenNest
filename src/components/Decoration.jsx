...
const Decoration = () => {
  return (
    <div>
      ...
      <div className=" grid sm:grid-rows-2 sm:grid-cols-3 gap-5  mx-10 *:rounded-2xl ">
        <div className="row-span-2 overflow-hidden">
          <img
          className=" w-full h-full object-cover hover:brightness-90 rounded-2xl transition-transform duration-500 hover:scale-105"
